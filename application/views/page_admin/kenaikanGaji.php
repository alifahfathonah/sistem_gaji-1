<script>
    ...
    function ubah(id) {
        ...
        $('.form-group').removeClass('has-error')
            ...
            .find('#text-error').remove();
        $.ajax({
            url: "<?php echo site_url('administrator/kenaikanGaji/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(resp) {
                ...
                $('[name="persentase"]').val(data.persentase);
                $('.reset').hide();
            },
    ...
    function hapus(id) {
        swal({
            ...
            function() {
                $.ajax({
                    url: "<?php echo site_url('administrator/kenaikanGaji/delete'); ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function simpan() {
        ...
        var url;
        if (save_method == 'add') {
            url = '<?php echo base_url() ?>administrator/kenaikanGaji/addData';
        } else {
            url = '<?php echo base_url() ?>administrator/kenaikanGaji/update';
        }
        swal({
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Persentase<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
