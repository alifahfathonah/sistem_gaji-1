...
<body>
    ...
    <h3 style="text-align: center;">Slip Gaji Bulanan</h3>
    <hr>
    <hr>
    <div id="outtable">
        <table>
            ...
            <thead>
                <th>
                    ...
                    <tr>
                        <th>Potongan Gaji</th>
                        <td>: <?php echo rupiah_format($getSlipGaji[0]->total_potongan); ?></td>
                    </tr>
                    <tr>
        ...
        <div class="text-right">
            <?php echo indo_date($getSlipGaji[0]->tanggal); ?> <br>Penerima Gaji,
            <br><br><br><br>
